...
const pipelineStack = new DayCareCdkStack(app, 'DCCdkStack', {
...
const serviceStackTest = new ServiceStack(app, 'DCServiceStackTest', {
  stageName: "Test"
})

const serviceStackProd = new ServiceStack(app, "DCServiceStackProd", {
  stageName: "Prod"
});
